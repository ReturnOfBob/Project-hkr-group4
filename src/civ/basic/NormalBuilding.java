...
//------------------------------CONSTRUCTOR-----------------------------------\\        
    public NormalBuilding(String name, int initialGold, int initialWood, int initialStone, int initialIron, int initialCoal, 
            int initialSteel, int initialFood, int initialHuman, int initialSoldier, int amount, int scoreValue, int gold, 
            int wood, int stone, int iron, int coal, int steel, int food, int human, int soldier) {
        
        super(name, initialGold,initialWood,initialStone, initialIron, initialCoal, initialSteel, 
                initialFood, initialHuman, initialSoldier, amount, scoreValue );
        this.gold = gold;
        this.wood = wood;
        this.stone = stone;
        this.iron = iron;
