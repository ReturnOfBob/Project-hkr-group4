...
public class EventStorage {
    ...
    private int eventChangeSoldier = 0;
    ...
    private double eventChangeSoldierMultiplier = 1;
    ...
    private double eventPercentageChangeSoldier = 1;
...
//--------------------------GETTERS & SETTERS---------------------------------\\
    ...
    public int getEventChangeSoldier() {
        return eventChangeSoldier;
    }

    public void setEventChangeSoldier(int eventChangeSoldier) {
        this.eventChangeSoldier = eventChangeSoldier;
    }

    public double getEventChangeSoldierMultiplier() {
        return eventChangeSoldierMultiplier;
    }

    public void setEventChangeSoldierMultiplier(double eventChangeSoldierMultiplier) {
        this.eventChangeSoldierMultiplier = eventChangeSoldierMultiplier;
    }

    public double getEventPercentageChangeSoldier() {
        return eventPercentageChangeSoldier;
    }

    public void setEventPercentageChangeSoldier(double eventPercentageChangeSoldier) {
        this.eventPercentageChangeSoldier = eventPercentageChangeSoldier;
    }
