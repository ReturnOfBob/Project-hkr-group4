...
//----------------------------NON-FXML METHODS--------------------------------\\
    ...
    private void refreshStatsViewColumns(boolean isNormalBuilding, int statsViewBuildingID) {
        ...
        if (isNormalBuilding == true) {
            statsViewDisplayList.add(new StatsViewDisplayObject("Gold:", Integer.toString((int) (normalBuildingList.get(statsViewBuildingID).getInitialGold() * buildingMultiplier() * difficultyMultiplier)), Integer.toString(normalBuildingList.get(statsViewBuildingID).getGold()), "", ""));
            statsViewDisplayList.add(new StatsViewDisplayObject("Wood:", Integer.toString((int) (normalBuildingList.get(statsViewBuildingID).getInitialWood() * buildingMultiplier() * difficultyMultiplier)), Integer.toString(normalBuildingList.get(statsViewBuildingID).getWood()), "", ""));
            statsViewDisplayList.add(new StatsViewDisplayObject("Stone:", Integer.toString((int) (normalBuildingList.get(statsViewBuildingID).getInitialStone() * buildingMultiplier() * difficultyMultiplier)), Integer.toString(normalBuildingList.get(statsViewBuildingID).getStone()), "", ""));
            statsViewDisplayList.add(new StatsViewDisplayObject("Iron:", Integer.toString((int) (normalBuildingList.get(statsViewBuildingID).getInitialIron() * buildingMultiplier() * difficultyMultiplier)), Integer.toString(normalBuildingList.get(statsViewBuildingID).getIron()), "", ""));
            statsViewDisplayList.add(new StatsViewDisplayObject("Coal:", Integer.toString((int) (normalBuildingList.get(statsViewBuildingID).getInitialCoal() * buildingMultiplier() * difficultyMultiplier)), Integer.toString(normalBuildingList.get(statsViewBuildingID).getCoal()), "", ""));
            statsViewDisplayList.add(new StatsViewDisplayObject("Steel:", Integer.toString((int) (normalBuildingList.get(statsViewBuildingID).getInitialSteel() * buildingMultiplier() * difficultyMultiplier)), Integer.toString(normalBuildingList.get(statsViewBuildingID).getSteel()), "", ""));
            statsViewDisplayList.add(new StatsViewDisplayObject("Food:", Integer.toString((int) (normalBuildingList.get(statsViewBuildingID).getInitialFood() * buildingMultiplier() * difficultyMultiplier)), Integer.toString(normalBuildingList.get(statsViewBuildingID).getFood()), "", ""));
            ...
            statsViewDisplayList.add(new StatsViewDisplayObject("Gold:", "", "", Integer.toString((int) (uniqueBuildingList.get(statsViewBuildingID).getInitialGold() * difficultyMultiplier)), Integer.toString((int) (100 * uniqueBuildingList.get(statsViewBuildingID).getBonusGold())) + "%"));
            statsViewDisplayList.add(new StatsViewDisplayObject("Wood:", "", "", Integer.toString((int) (uniqueBuildingList.get(statsViewBuildingID).getInitialWood() * difficultyMultiplier)), Integer.toString((int) (100 * uniqueBuildingList.get(statsViewBuildingID).getBonusWood())) + "%"));
            statsViewDisplayList.add(new StatsViewDisplayObject("Stone:", "", "", Integer.toString((int) (uniqueBuildingList.get(statsViewBuildingID).getInitialStone() * difficultyMultiplier)), Integer.toString((int) (100 * uniqueBuildingList.get(statsViewBuildingID).getBonusStone())) + "%"));
            statsViewDisplayList.add(new StatsViewDisplayObject("Iron:", "", "", Integer.toString((int) (uniqueBuildingList.get(statsViewBuildingID).getInitialIron() * difficultyMultiplier)), Integer.toString((int) (100 * uniqueBuildingList.get(statsViewBuildingID).getBonusIron())) + "%"));
            statsViewDisplayList.add(new StatsViewDisplayObject("Coal:", "", "", Integer.toString((int) (uniqueBuildingList.get(statsViewBuildingID).getInitialCoal() * difficultyMultiplier)), Integer.toString((int) (100 * uniqueBuildingList.get(statsViewBuildingID).getBonusCoal())) + "%"));
            statsViewDisplayList.add(new StatsViewDisplayObject("Steel:", "", "", Integer.toString((int) (uniqueBuildingList.get(statsViewBuildingID).getInitialSteel() * difficultyMultiplier)), Integer.toString((int) (100 * uniqueBuildingList.get(statsViewBuildingID).getBonusSteel())) + "%"));
            statsViewDisplayList.add(new StatsViewDisplayObject("Food:", "", "", Integer.toString((int) (uniqueBuildingList.get(statsViewBuildingID).getInitialFood() * difficultyMultiplier)), Integer.toString((int) (100 * uniqueBuildingList.get(statsViewBuildingID).getBonusFood())) + "%"));
